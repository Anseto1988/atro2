...
| v2.7.0-alpha | — | — | F-NoiseEstimator (MAD-Sigma-Clipping, SNR, Auto-Detect), F-SelectiveColorSaturation (HSV, 7 Hue-Ranges, Qt-Panel), F-AdaptiveDenoise (NoiseEstimator-Pipeline-Step, Adaptive-Checkbox) — +143 Tests, ~3546+ Gesamt |
