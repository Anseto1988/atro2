...
| v2.8.0-alpha | — | — | F-MTFStretch (Midtone Transfer Function, Auto-BTF), F-BackgroundNeutralization (Auto/ROI-Modus, per-Kanal), F-LocalContrastEnhancement (CLAHE pure numpy, Luminanz/pro-Kanal), F-StarReduction (Minimum-Filter, Gaussian-Mask, Blend) — +267 Tests, ~3940+ Gesamt |
